...
<head>
    ...
    <title>BIKO -  Perfil não encontrado!</title>
    <link rel="icon" type="image/png" href="img/icon.png">
    <link href="style/not-found.scss" rel="stylesheet" />
...
<body>
    ...
    <div class="foto">
        <img class="lost-404" src="img/lost-404.png">
    </div>
    <p>Pelo visto, você se perdeu... tente acessar essa página novamente mais tarde ou tente outras opções. Se o erro persistir, entre em contato pelo suporte!</p>
